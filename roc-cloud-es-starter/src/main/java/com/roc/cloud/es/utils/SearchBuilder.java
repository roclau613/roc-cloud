package com.roc.cloud.es.utils;
...
import com.roc.cloud.core.model.EsPageResult;
...
//
     ...
     * @param limit 每页显示
     */
    public EsPageResult<JSONObject> getPage(Integer page, Integer limit) throws IOException {
        ...
        return EsPageResult.<JSONObject>builder().data(list).code(0).count(totalCnt).build();
    }
