...
import com.roc.cloud.db.datasource.AbstractDynamicDataSource;
import com.roc.cloud.db.datasource.DynamicDataSource;
 ...
 **/
@Slf4j
@ConditionalOnProperty(name = "roc.cloud.dynamic.enabled", havingValue = "true")
@ComponentScan(basePackages = "com.roc.cloud.db")
public class DynamicDataSourceConfiguration {
    ...
    public DataSource dataSource() {
        ...
        //配置多个数据源
        Map<Object, Object> map = new ConcurrentHashMap<>(1);
