...
public class CommonFeignErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        if (response == null || body == null) {
            return new ServiceException(CodeEnum.ERROR);
        }
        ...
        if (responseStatus >= NOT_FOUND_CODE && responseStatus < ERROR_500_CODE) {
            ...
            return new ServiceException(CodeEnum.REMOTE_SERVICE_NOT_FOUND);
        }
        String responseBody = "";
        try {
            ...
            return new ServiceException(CodeEnum.REMOTE_SERVICE_ERROR);
        }
        ...
        return new ServiceException(jsonObject.getInteger(FIELD_CODE), jsonObject.getString(FIELD_MSG));
    }
